...
import { AreaChart, Area, CartesianGrid, Tooltip, YAxis, XAxis } from 'recharts';
...
export default class MyLineChart extends Component {
    ...
    render() {
      ...
      const data   = mapData(props.data, props.divider)
        return (
          <AreaChart data={data} margin={{top: 30, right: 30, bottom: 20, left: 10}} width={520} height={320}>
